          ...
          <div className="card flex flex-col md:flex-row lg:flex-row block bg-white rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            ...
            <div className="right-section w-full md:w-4/6 lg:w-4/6 max-h-full lg:max-h-[500px] ">
              ...
              <div className="book-description px-7 lg:px-12 pt-3 lg:pt-10 pb-12 md:pb-5 mr-2 lg:mr-5">
                <h3 className="title text-xl lg:text-3xl py-2 mt-5">{dataBuku && dataBuku.title}</h3>
                <h3 className="author text-md lg:text-xl py-2">{dataBuku && dataBuku.author}</h3>
                <h4 className="publish-date text-sm lg:text-md py-1">{dataBuku && dataBuku.isbn}</h4>
                <h4 className="publish-date text-sm lg:py-1">Penerbit       : {dataBuku && dataBuku.publisher}</h4>
                <h4 className="publish-date text-sm lg:text-md py-1">Tanggal Terbit : {dataBuku && dataBuku.publishDate.split("T")[0]}</h4>
                <p className="sinopsis text-sm py-2 pb-4">{dataBuku && dataBuku.description}</p>
                <div className="date-section flex flex-row py-2">
                <h3 className="mr-2 text-sm lg:text-md">Tanggal Pengembalian :</h3>
                <input
                  type="date"
              ...
              {idAnggota !== "" ? 
                (<button onClick={tombolPinjamBuku} className="rounded-full text-sm lg:text-md p-2 mt-5 md:mt-2 mb-3 bg-slate-800 text-white w-full">Pinjam Buku</button> )
